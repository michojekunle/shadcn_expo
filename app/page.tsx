...
export default function Home() {
  return (
    <main className="w-full px-4 md:px-8 py-4 h-full flex flex-col md:flex-row items-center justify-between gap-7">
      <div className='mt-11'>
        <h1 className='text-4xl md:text-7xl font-mono font-bold w-4/5 sm:max-w-xs md:max-w-md sm:text-left text-center'>Welcome to <span className='bg-gradient-to-r from-purple-500 to-pink-500 bg-clip-text text-transparent'>ShadCn Expo</span></h1>
