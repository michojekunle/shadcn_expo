...
export default function Home() {
  return (
    <main className="w-full px-4 md:px-8 py-4 h-full flex flex-col md:flex-row items-center justify-between gap-7">
      ...
      <div className="w-4/5 sm:w-[320px] sm:h-[300px] md:w-[360px] h-[350px] lg:w-[450px] lg:h-[400px] xl:w-[600px] xl:h-[450px] rounded-2xl border-4 border-slate-100 overflow-hidden">
        <Image
